...
class ComputeContactAtom : public Compute {
 public:
  ...
  virtual void radius_sort(double *, int); //tarun
  virtual int tag_to_serial(int); //tarun
  virtual int radiusToNumber(double ,double *); //tarun
 ...
 protected: 
  ...
  double *contact;
  double skin,p=0.0, rad[10]; 
  int N_col_final[10][10];
  int contact_search[150000][20], contact_search_old[150000][20];
