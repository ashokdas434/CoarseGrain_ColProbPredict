...
void ComputeContactAtom::compute_peratom()
{
  ...
  //for (int i=0;i<10;i++) rad[i]=100; //it can help sorting


  //radius_sort(rad, nlocal); //calling this function helps obtaining and sorting radius information


  double rad[]={0.0013365, 0.0016839, 0.0019276, 0.0021216, 0.0022854, 0.002673, 0.0033678, 0.0038552, 0.0042432, 0.0045708};
